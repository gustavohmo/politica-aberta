...
sub file_load_query() {
    ...
    if ($query_tipo eq "candidato") {
        return  "-e \"LOAD DATA LOCAL INFILE '$_[1]' INTO TABLE $query_tabela_import CHARACTER SET utf8 COLUMNS TERMINATED BY ';' ENCLOSED BY '\\\"' IGNORE 1 LINES (data_e_hora,sequencial_candidato,uf,numero_ue,municipio,sigla_partido,numero_candidato,cargo,nome_candidato,cpf_candidato,numero_recibo_eleitoral,numero_documento,cpf_cnpj_doador,nome_doador,nome_receita_doador,sigla_ue_doador,numero_partido_doador,numero_candidato_doador,cod_setor_econ_doador,setor_econ_doador,data_receita,valor_receita,tipo_receita,fonte_recurso,especie_recurso,descricao_receita)\"";
    }
    elsif ($query_tipo eq "comite") {
        return "-e \"LOAD DATA LOCAL INFILE '$_[1]' INTO TABLE $query_tabela_import CHARACTER SET utf8 COLUMNS TERMINATED BY ';' ENCLOSED BY '\\\"' IGNORE 1 LINES (data_e_hora,sequencial_comite,uf,numero_ue,municipio,tipo_comite,sigla_partido,tipo_de_documento,numero_do_documento,cpf_cnpj_doador,nome_doador,nome_receita_doador,sigla_ue_doador,numero_partido_doador,numero_candidato_doador,cod_setor_econ_doador,setor_econ_doador,data_receita,valor_receita,tipo_receita,fonte_recurso,especie_recurso,descricao_receita)\"";
    }
    elsif ($query_tipo eq "partido") {
        return "-e \"LOAD DATA LOCAL INFILE '$_[1]' INTO TABLE $query_tabela_import CHARACTER SET utf8 COLUMNS TERMINATED BY ';' ENCLOSED BY '\\\"' IGNORE 1 LINES (data_e_hora,sequencial_diretorio,uf,numero_ue,municipio,tipo_diretorio,sigla_partido,tipo_documento,numero_documento,cpf_cnpj_doador,nome_doador,nome_receita_doador,sigla_ue_doador,numero_partido_doador,numero_candidato_doador,cod_setor_econ_doador,setor_econ_doador,data_receita,valor_receita,tipo_receita,fonte_recurso,especie_recurso,descricao_receita)\"";
    }
    else { die; }
}
